...
public class RecoBackgroundMonitoringService extends Service implements RECOMonitoringListener, RECOServiceConnectListener{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
         ...
         */
        mRecoManager = RECOBeaconManager.getInstance(getApplicationContext(), StateActivity.SCAN_RECO_ONLY, StateActivity.ENABLE_BACKGROUND_RANGING_TIMEOUT);
    ...
    private void generateBeaconRegion() {
        ...
        recoRegion = new RECOBeaconRegion(StateActivity.RECO_UUID, "RECO Sample Region");
    ...
    private void popupNotification(String msg) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this).setSmallIcon(R.drawable.mini)
